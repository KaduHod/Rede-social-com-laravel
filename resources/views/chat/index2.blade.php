...
<div class="container">
    ...
    <div id="leftSideChat">
        <ul id="leftSideChatOptions">
            ...
            <li>
                <ion-icon id="chats" class="white2" name="chatbubbles"></ion-icon>
            </li>
            <li>
                <ion-icon id="followers" name="people"></ion-icon>
            </li>
        </ul>
                                ...
                                <div class="chatUsersNameLastText" >
                                    ...
                                    <div class="chatUsersLastText">
                                        @php
                                            ...
                                            $new_date = new DateTime($chat->messages[$ultimaMensagem]->created_at) ;
    ...
    <div class="textContainer">
        ...
        @else
            ...
            @else{{--Caso user não tenho nao siga ninguem--}}
                <div class="infoConversation">
                    <div class="chatUserProfilePic" id="chatUserProfilePic" style="background-image: url('/img/profilePictures/ ')">
                    </div>
                    <h6 class="nomeUser" id="nomeUser"></h6>
                    <ion-icon name="build-outline"></ion-icon>
                </div>
                <div class="textsCoversation">
                    nenhuma mensagem ainda
